...
// Use Data from Intent to Show Name & Budget to User
        ...
        String userBudgetString = Double.toString(userBudget);
...
// Display Budget
        ...
        budgetView.setText("Your Budget today is: $" + userBudgetString);
    }
    ...
    DupeChecker ItemDupeCheck = new DupeChecker();
            ...
            case R.id.AddItemButton:
                ...
                if (!nameEntryView.getText().toString().isEmpty() && (nameEntryView.getText().toString() != "") &&
                    ...
                    if (price > 0 && quantity > 0 && priority > 0) {
                        ShoppingItem testItem = new ShoppingItem(name, price, priority, quantity);

                        int nameAcceptable = ItemDupeCheck.ListNameDupeCheck(UserShoppingArrayList, testItem);
                        ...
                        if(nameAcceptable == 1) {
                            ...
                            Toast toast = Toast.makeText(context, "You entered a Duplicate Item Name."+"\n"+"Try Again.", Toast.LENGTH_SHORT);
                            toast.setGravity(Gravity.TOP|Gravity.CENTER_HORIZONTAL, 80, 0);
                            toast.show();
                            }
                        }
                    }
                ...
                else
             {
                        ...
                        Toast toast = Toast.makeText(context, "Please fill out all values.", Toast.LENGTH_SHORT);
                        toast.setGravity(Gravity.TOP|Gravity.CENTER_HORIZONTAL, 80, 0);
                        toast.show();
            }
